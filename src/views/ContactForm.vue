    ...
    <div class="text-center my-6 w-11/12 md:w-full mx-auto">
      <form class="text-left inline-block border p-4 md:p-11 shadow-md" >
        ...
        <div class="text-center">
          <button class="w-24 mr-2 tracking-wider text-center border hover:bg-orange rounded-full hover:text-white px-0 py-2 transition duration-300 ease-in-out bg-transparent text-gray-800 border-orange focus:outline-none" @click="submit"><font-awesome-icon class="mr-1 text-yellow-900" :icon="['fas', 'check']" />送信</button>
        </div>
      </form>
    </div>
