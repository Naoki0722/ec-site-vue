    ...
    <div class="text-center my-6 w-11/12 md:w-full mx-auto">
      <form class="text-left inline-block border p-4 md:p-11 shadow-md">
        <div class="pb-6">
          ...
          <input type="text" id="name" name="name" class="border rounded border-gray-300 px-2 py-1 font-sans focus:outline-none" placeholder="山田太郎">
        </div>
        <div class="pb-6">
          <label for="email" class="block w-56 float-left">メールアドレス</label>
          <input type="mail" id="email" name="email" class="border rounded border-gray-300 px-2 py-1 font-sans" placeholder="test@test.com">
        </div>
        <div class="pb-6">
          <label for="tell" class="block w-56 float-left">電話番号</label>
          <input type="text" id="tell" name="tell" class="border rounded border-gray-300 px-2 py-1 font-sans focus:outline-none" placeholder="000-0000-0000">
        </div>
        <div class="w-full">
          <label for="message" class="block mb-4">お問い合わせ内容</label>
          <textarea  id="message" name="message" class="border rounded border-gray-300 px-2 py-1 w-full h-36 mb-6 focus:outline-none" placeholder="ここにお問い合わせ内容を入力ください。"></textarea>
        </div>
        <div class="text-center">
          <button class="w-24 mr-2 tracking-wider text-center border hover:bg-orange rounded-full hover:text-white px-0 py-2 transition duration-300 ease-in-out bg-transparent text-gray-800 border-orange focus:outline-none" @click="$router.push('/contact_confirm')"><font-awesome-icon class="mr-1 text-yellow-900" :icon="['fas', 'check']" />確認</button>
        </div>
      </form>
    </div>
