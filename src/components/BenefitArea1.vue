<template>
  <div class="flex flex-wrap lg:flex-nowrap lg:justify-center mb-24 lg:mb-40 h-auto items-start">
    <img src="../assets/product_1.jpg" alt="ピアス" class="relative z-20 w-4/5 lg:w-2/5 mx-auto">
    <div class="relative z-10 p-6 lg:p-0 w-4/5 lg:w-2/5 mx-auto lg:mx-0 bg-gray-100 lg:bg-transparent font-serif text-yellow-900">
